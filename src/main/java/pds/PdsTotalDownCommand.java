...
//		클라이언트(서블릿)한테 보내기
		...
		String zipName = vo.getTitle() + ".zip"; // 압축 파일 이름
...
//			담은 자료를 압축 zip에 담아주기(객체를 담은 것임)
		...
		zos.close();
//		여기까지의 작업이 압축하는 서버의 작업
		
		
//		서버에서 압축 작업이 완료되면, 압축 파일을 클라이언트로 전송하고, 서버에 존재하는 압축 파일파일을 삭제한다.
