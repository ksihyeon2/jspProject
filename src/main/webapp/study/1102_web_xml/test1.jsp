...
<body>
	...
	<div class="container">
		...
		<form method="post" action="${ctp}/j1102/test1Ok" >
			...
			<div><input type="submit" value="전송하기1" class="btn-info form-control" /></div>
			<div><input type="button" value="전송하기2" onClick="location.href='${ctp}/j1102/test1Ok2	';" class="btn-primary form-control" /></div>
		</form>
	</div>
	<p><br /></p>
</body>
