...
<jsp:include page="/include/header.jsp"></jsp:include>
	...
	<div class="container">
		...
		<hr />
		<div>
			<input type="button" value="test5_1.jsp" onClick="location.href='${ctp}/mapping2/test5.re';" class="btn btn-success m-3"/>
			<input type="button" value="test5_2.jsp" onClick="location.href='${ctp}/mapping2/test5_2.re';" class="btn btn-primary m-3"/>
		</div>
		<hr />
		<pre>
