...
<jsp:include page="/include/header.jsp"></jsp:include>
	<p><br /></p>
	<div class="container">
		<h2 class="text-center">게 시 판 글 작 성</h2>
			...
			<table class="table table-bordered">
				...
				<tr>
					<td colspan="2" class="text-center">
						<input type="submit" value="작성 완료" class="btn btn-info"/> &nbsp;
						<input type="reset" value="다시 입력" class="btn btn-warning"/> &nbsp;
						<input type="button" onclick="location.href='boardList.bo';" value="돌아가기" class="btn btn-danger"/>
					</td>
				</tr>
			</table>		
