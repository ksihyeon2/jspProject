...
// 어노테이션을 이용 방법
@WebServlet (urlPatterns="/j1102/Test4Ok", initParams = {@WebInitParam(name="logoName",value="그린 자바 주식회사"),@WebInitParam(name="homeAddress",value="http://192.168.50.62:9090/javaProject/study/1102_web_xml/test1.jsp")})
