...
<body>
	...
	<div class="container">
		<h2>JSP 각종 주석</h2>
		<!-- 이곳은 HTML (여러줄&한줄)주석입니다.  -->
		<%-- 이곳은 JSP 주석입니다.(본문) --%>
		<%	/* 자바코드를 작성하기 위한 명령어 : 스크립틀릿(scriptlet) */
			// 이곳은 자바코드를 작성하는 곳입니다.
			//System.out.println("이곳은 JSP 파일 안 입니다.");  // 콘솔에 출력하는 명령
		
			out.println("브라우저에 출력됩니다.<br />");  // 뷰에 출력하는 명령
