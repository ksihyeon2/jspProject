...
<head>
	...
	<script>
		...
		function fileBoxAppend() {
			...
			fileBox+= '<input type="file" name="fName'+cnt+'" id="file'+cnt+'" class="form-control-file mb-3 border" />';
			fileBox+= '<div class="input-group-append" >';
	...
	<div class="container">
		...
		<!-- multipart/form-data로 파일을 업로드 하면 파일명이 서버에 저장되어 보내지기 때문에 이름이 넘어가지 않음 -->
			...
			<div>
				...
				<input type="file" name="fName1" id="file1" class="form-control-file mb-3 border" />
			</div>
			<div id="fileBox"></div>
